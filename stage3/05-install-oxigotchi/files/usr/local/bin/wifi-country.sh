...
# for every user — jayofelony's own images ship with a working default this
# same way, this project just never carried it over.

set -u

MARKER=/etc/oxigotchi/.wifi-country-configured
[ -f "$MARKER" ] && exit 0
